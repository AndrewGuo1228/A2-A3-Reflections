...
> .Apply( )
The first technique that worth memorizing would be the **apply** method, this method is very powerful when we want to transform the specific columns, we can
...
This is also an important takeway from this assignment, how can we access and interpret the result of the OLS regression summary
